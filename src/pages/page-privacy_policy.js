        ...
        <div className="container">
          <div className="col-lg-12">
            <div className="title-heading">
              ...
              <span className="fw-bold text-normal">
                {""}
              ...
              <div className="h3 fw-bold text-decoration-underline mb-0">
                {"Interpretation and Definitions"}
              </div>
              <div className="h4 fw-bold mb-0">Interpretation</div>
              <span className="fw-bold text-normal">
              ...
              <div className="h4 fw-bold mb-0">Defination</div>
              <div className="indent h7 text-muted mb-0">
              ...
              <p className="indent text-muted h6 fw-normal">
                <ul>
                  ...
                  <li>
                    ...
                    “Our” in this Agreement) refers to CodeElan Technologies
                    Pvt. Ltd. , E402, S3 Lifestyle Internal Rd, Apartments,
                  ...
                  <li>
                    Usage Datarefers to data collected automatically, either
                    generated by the use of the Service or from the Service
                    infrastructure itself (for example, the duration of a page
                    visit).
                  </li>
                  <li>
                    Websiterefers to CodeElan Technologies, accessible from
                    https://codeelan.com/
                  </li>
                  <li>
              ...
              <div className="h4 fw-bold">Types of Data Collected</div>
              <span className="h5 fw-semibold text-normal">Personal Data</span>
              <span className="fw-bold text-normal">
                <p className="indent text-muted h6 fw-normal">
              ...
              <span className="h5 fw-semibold text-normal">Usage Data</span>
              <span className="fw-bold text-normal">
                <p className="indent text-muted h6 fw-normal">
              ...
              <span className="h5 fw-semibold text-normal">
                Tracking Technologies and Cookies
              </span>
              <span className="fw-bold text-normal">
                <p className="text-muted h6 fw-normal">
                  ...
                  <div className="indent fw-normal text-dark ">
                    We use both Session and Persistent Cookies for the purposes
                    set out below:
                  </div>
                  <ul>
                    <li className="indent fw-bold text-dark ">
                  ...
                  <div className="indent fw-normal text-muted ">
              ...
              <div className="h4 fw-bold  ">Use of Your Personal Data</div>
              <span className="fw-bold text-normal">
                <p className="indent text-muted h6 fw-normal">
              ...
              <div className="h4 fw-bold">Retention of Your Personal Data </div>
              <p className="indent text-muted h6 fw-normal">
              ...
              <div className="h4 fw-bold">Transfer of Your Personal Data</div>
              <p className="indent text-muted h6 fw-normal">
              ...
              <div className="h4 fw-bold">Delete Your Personal Data</div>
              <p className="indent text-muted h6 fw-normal">
              ...
              <div className="h4 fw-bold">Business Transactions</div>
              <p className="indent text-muted h6 fw-normal">
              ...
              <div className="h4 fw-bold">Law enforcement</div>
              <p className="indent text-muted h6 fw-normal">
              ...
              <span className="fw-semi_bold text-dark">
                Other legal requirements
              </span>
              <p className="indent text-muted h6 fw-normal">
                The Company may disclose Your Personal Data in the good faith
                belief that such action is necessary to:
                <ul className="indent text-muted">
                  <li className="indent text-muted">
              ...
              <div className="h4 fw-bold">Security of Your Personal Data</div>
              <p className="indent text-muted h6 fw-normal">
              ...
              <div className="h4 fw-bold">Children’s Privacy</div>
              <p className="indent text-muted h6 fw-normal">
              ...
              <div className="h4 fw-bold">Links to Other Websites"</div>
              <p className="indent text-muted h6 fw-normal">
              ...
              <div className="h4 fw-bold">Changes to this Privacy Policy</div>
              <p className="indent text-muted h6 fw-normal">
              ...
              <div className="h4 fw-bold">Contact Us</div>
              <p className="indent text-muted h6 fw-normal">
                If you have any questions about this Privacy Policy, You can
                contact us:
                <ul>
                  <li>By email: info@codeelan.com</li>
                  <li>
